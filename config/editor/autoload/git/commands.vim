...
func! git#commands#author(start, end, all_commits) abort
  ...
  let l:authors = s:find_authors_for_range(a:start, a:end, a:all_commits)

  if l:authors is# v:null
    return v:null
  endif

  for [l:author, l:ownership] in l:authors
    echohl Clear
    echo l:author
    echohl Comment
    echon ' (' . l:ownership . '%)'
