...
vim.api.nvim_set_keymap('i', '<expr><tab>', 'editor#mappings#tab_completion(v:false)', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '<expr><s-tab>', 'editor#mappings#tab_completion(v:true)', { noremap = true, silent = true })
